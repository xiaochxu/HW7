<%@ Page Language="VB" AutoEventWireup="false" CodeFile="xall.aspx.vb" Inherits="_Default" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="Sql_default">
            <Columns>
